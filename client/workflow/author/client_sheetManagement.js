  ...
  sm_renderGrid = function(containerId, gridData){
      ...
      //var hotInstance = $(containerId).handsontable('getInstance');
      //$container.handsontable(containerId)
}
...
Template.sheetManagement.onRendered(function() {
    ...
    window.downloadCSV = function(args) {
      ...
      console.log("sheetManagment Rendered")
      sId = queryString()['sheetId']
      console.log("sheet Id is: " + sId)
      Meteor.subscribe("sheetIdData", sId, {
        onReady: function(){
           sm_renderGrid("#rawSheetDataGrid", sheetData.find({sheetId: sId} , {fields: {_id: 0, sheetId: 0, authorId:0}}).fetch())
        }
      })
...
Template.sheetManagement.helpers({
